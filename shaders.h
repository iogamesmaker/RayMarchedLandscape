...
public:
    ...
    Shader(const char* vertexPath, const char* fragmentPath)
    {
        ...
        {
            std::cout << "Shader file couldn't be read: " << e.what() << std::endl;
        }
        ...
        std::cout << "Loaded vertex shader: " << vertexPath << std::endl;
        std::cout << "Loaded fragment shader: " << fragmentPath << std::endl;
    }
    // activate the shader
    // ------------------------------------------------------------------------
    void use()
    ...
    void checkCompileErrors(unsigned int shader, std::string type)
    {
        ...
        if (type != "PROGRAM")
        {
            ...
            if (!success)
            {
                ...
                std::cout << "Shader compile error of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
            }
        }
        else
        {
